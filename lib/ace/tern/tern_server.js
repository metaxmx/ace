...
define(function (require, exports, module) {
    ...
    exports.closeAllTips = closeAllTips;
    //#endregion
        ...
        ts.request(editor, {
            ...
            function (error, data) {
                ...
                function bindPopupSelect() {
                    if (editor.ternPopupSelectBound) {
                        return false;
                    }
                    ...
                    editor.ternPopupSelectBound = true; //prevent rebinding
                }
                ...
                function popupSelectionChanged() {
                    ...
                    tooltip = makeTooltip(0,0, createInfoDataTip(data, true), editor);

                    var popup = editor.completer.popup;
                    var rect = popup.container.getBoundingClientRect();
                    tooltip.style.top = popup.container.style.top;
                    tooltip.style.bottom = popup.container.style.bottom;
                    if (window.innerWidth - rect.right < 320) {
                        if (rect.left < 320) {
                            if(popup.isTopdown) {
                                ...
                                tooltip.style.top = popup.container.offsetTop - tooltipNode.offsetHeight + "px";
                                tooltip.style.left = rect.left + "px";
                                tooltip.style.right = "";
                                tooltip.style.bottom = "";
                            }
    ...
    function showType(ts, editor, pos, calledFromCursorActivity) {
        ...
        var cb = function (error, data, typeData) {
            ...
            setTimeout(function () {
                ...
                // setTimeout(function(){console.log('place after 1ms', getCursorPosForTooltip(editor));},1);
    ...
    function getCursorPosForTooltip(editor) {
        ...
        pos.left += editor.renderer.gutterWidth;

        var screenHeight = window.innerHeight;
        var screenWidth = window.innerWidth;

        //-20 and 17 are arbitrary numbers that seem to put the tooltip in the right place
        pos.left -= 20;
        pos.top += 17;

        if (pos.left + 300 > screenWidth && screenWidth > 300) {
            // Keep at least 300px from right side to have enough space for displaying
            pos.left = screenWidth - 300;
        }
    ...
    function updateArgHints(ts, editor) {
        clearTimeout(editor.tern_debounce_updateArgHints);
        closeArgHints(ts);
        ...
        editor.tern_debounce_updateArgHints = setTimeout(inner, 500);
